...
contract PettraFinance is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'Pettra Finance';
    string  private _SYMBOL = 'PeFi';
    ...
    uint256 private _tTotal = 10000000000000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 10000000000000000 * _DECIMALFACTOR;
